...
// Asumsikan file mock books ada di lib/mock
...
   return (
      <section
         // Container utama yang mengatur background dan padding horizontal global
         className="bg-gradient-to-b from-pink-50 via-purple-50 to-blue-50
      dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6 md:p-10 rounded-xl"
      >
         
         {/* --- HERO SECTION CONTAINER (Selamat Datang & Kategori Populer) --- */}
         <motion.div
            // Grid container utama, memastikan 3 kolom untuk desktop (2/3 dan 1/3)
...
         >
            
            {/* Left Content (Selamat datang) - Mengambil 2 kolom */}
            <motion.div
...
            {/* Right Categories (Kategori Populer) - Mengambil 1 kolom */}
            <motion.div
...
               }}
            >
               {/* Memastikan hanya 4 kartu yang dirender untuk mengisi 4 kolom grid */}
...
         </div>
           ...
           {/* --- BAGIAN GENRE DITAMBAHKAN DI SINI --- */}
           <motion.div
               className="mt-12" 
               initial={{ opacity: 0, y: 30 }}
               animate={{ opacity: 1, y: 0 }}
